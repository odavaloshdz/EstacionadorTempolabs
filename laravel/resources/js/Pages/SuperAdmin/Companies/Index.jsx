        ...
        <SuperAdminLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Empresas</h2>
                    <Link
                                                ...
                                                <tr key={company.id}>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            <div className="flex-shrink-0 h-10 w-10">
                                                                {company.logo ? (
                                                                    <img className="h-10 w-10 rounded-full object-cover" src={`/storage/${company.logo}`} alt={company.name} />
                                                                ) : (
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {company.subscription_end ? (
                                                            <div>
                                                                <div>{company.subscription_type}</div>
                                                                <div>Vence: {new Date(company.subscription_end).toLocaleDateString()}</div>
                                                            </div>
                                                        ) : (
                                                            <span className="text-yellow-600">Sin suscripción</span>
                                                        )}
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <div className="flex space-x-2">
                                                            ...
                                                            <Link
                                                                href={route('superadmin.companies.destroy', company.id)}
                                                                method="delete"
                                                                as="button"
