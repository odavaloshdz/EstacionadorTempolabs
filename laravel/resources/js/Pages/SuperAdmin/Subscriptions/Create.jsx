...
export default function Create({ auth, companies, subscriptionPlans, preselectedCompanyId = null }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('superadmin.subscriptions.store'), {
            onSuccess: () => reset(),
        });
    };

    // Si hay una empresa preseleccionada, establecerla al cargar el componente
    useEffect(() => {
        if (preselectedCompanyId) {
            setData('company_id', preselectedCompanyId);
        }
        ...
        <SuperAdminLayout
            ...
            header={
                <div className="flex items-center">
                    ...
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Crear Nueva Suscripción</h2>
                </div>
            }
        >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                required
                                                disabled={preselectedCompanyId !== null}
                                            >
